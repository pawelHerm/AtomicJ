...
public class NanoscopeSourceReader extends AbstractSourceReader<ChannelSource>
{	
    private static final String[] ACCEPTED_EXTENSIONS = new String[] {"([-0-9]++[0-9.Ee-]*+)", "pfc", "mca", "spm"};
    private static final String DESCRIPTION = "Nanoscope files (.001,..., .spm, .mca, .pfc)";

    private final NanoscopeImageReader imageReader = new NanoscopeImageReader();
    private final NanoscopeGeneralSpectroscopyReader spectroscopyReader = new NanoscopeGeneralSpectroscopyReader();
