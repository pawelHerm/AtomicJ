...
public class CSVSourceReader extends AbstractSourceReader<ChannelSource>
{	
    private static final String[] ACCEPTED_EXTENSIONS = new String[] {"csv"};
    private static final String DESCRIPTION = "Comma separated values file (.csv)";

    private final CSVImageReader imageReader = new CSVImageReader();
    private final CSVSpectroscopyReader spectroscopyReader = new CSVSpectroscopyReader();
