...
public class OpenSourceSelectionPage extends AbstractMultipleSourceSelectionPage<ChannelSource> implements WizardPage
{
    private static final String TASK_NAME = "Open";
    private static final String TASK_DESCRIPTION = "Select files to open";

    public OpenSourceSelectionPage(OpeningModelStandard<ChannelSource> model)
    {
        super(model, GeneralSourceReadingModel.getInstance(), "", false, "Open");
    }
