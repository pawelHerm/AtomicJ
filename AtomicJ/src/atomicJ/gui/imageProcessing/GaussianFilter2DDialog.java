...
public class GaussianFilter2DDialog extends BatchProcessingDialog <GaussianBasedFilter2DModel, String> implements PropertyChangeListener
{
    ...
    private final JSpinner spinnerSigmaX = new JSpinner(new SpinnerNumberModel(initSigmaX, 0, 20, 0.5));
    private final JSpinner spinnerSigmaY = new JSpinner(new SpinnerNumberModel(initSigmaY, 0, 20, 0.5));
