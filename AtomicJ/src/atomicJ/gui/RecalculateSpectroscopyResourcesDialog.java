...
public class RecalculateSpectroscopyResourcesDialog extends ResourcesBasedDialog<RecalculateSpectroscopyResourcesModel>
{
    ...
    public RecalculateSpectroscopyResourcesDialog(Window parent, boolean temporary) 
    {
    ...
    {
        super.setResourcesAvailable(available);
    ...
    protected void pullModelParameters()
    {
        ...
        RecalculateSpectroscopyResourcesModel model = getModel();
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        if(RecalculateSpectroscopyResourcesModel.INCLUDED_IN_MAPS.equals(property))        
        {
            boolean valNew = (boolean)evt.getNewValue();
            boxModifyMapInPlace.setEnabled(valNew);            
        }
        else if(RecalculateSpectroscopyResourcesModel.MODIFY_MAPS_IN_PLACE.equals(property))
        {
            boolean valNew = (boolean)evt.getNewValue();
        ...
        else if(RecalculateSpectroscopyResourcesModel.DELETE_OLD_CURVE_CHARTS.equals(property))
        {
            boolean valNew = (boolean)evt.getNewValue();
        ...
        else if(RecalculateSpectroscopyResourcesModel.DELETE_OLD_NUMERICAL_RESULTS.equals(property))
        {
            boolean valNew = (boolean)evt.getNewValue();
