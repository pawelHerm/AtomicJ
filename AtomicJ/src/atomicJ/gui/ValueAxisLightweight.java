...
implements Cloneable, PublicCloneable, Serializable {
    ...
    {
        Validation.requireNonNullParameterName(arrow, "arrow");
    ...
    {
        this.downArrow = Validation.requireNonNullParameterName(arrow, "arrow");
        notifyListeners(new AxisChangeEvent(this));
    }
    ...
    public void setLeftArrow(Shape arrow) {
        this.leftArrow = Validation.requireNonNullParameterName(arrow, "arrow");
        notifyListeners(new AxisChangeEvent(this));
    }
    ...
    public void setDefaultAutoRange(Range range) {
        Validation.requireNonNullParameterName(range, "range");
