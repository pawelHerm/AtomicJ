...
import atomicJ.gui.ImageSingleSourceSelectionPage;
...
public class ROISelectionWizardModel extends AbstractModel implements PropertyChangeListener
{
    ...
    private ImageSingleSourceSelectionPage sourceSelectionPage;
    ...
    private ImageSourceSelectionModel sourceSelectionModel;
    ...
    public ROISelectionWizardModel(PreviewDestination previewDestination, ROIWizardReceiver roiImageReceiver, ChannelFilter dataTypeFilter
    ...
    public ImageSource getSelectedSource()
    {
        List<ImageSource> sources = sourceSelectionModel.getSources();
    ...
    public void reset()
    {
        ...
        this.sourceSelectionModel = new ImageSourceSelectionModel(previewDestination, sourceSelectionDescriptor.getTaskName(),
                sourceSelectionDescriptor.getTaskDescription(), sourceSelectionDescriptor.isFirst(), sourceSelectionDescriptor.isLast());
        ...
        {
            this.sourceSelectionPage = new ImageSingleSourceSelectionPage(sourceSelectionModel);       
    ...
    public void finish()
    {
        if(finishEnabled)
        {
            ...
            ImageSource selectedSource = getSelectedSource();
