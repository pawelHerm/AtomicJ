...
public class ROISelectionWizard extends JDialog implements PropertyChangeListener, MessageDisplayer
{
    ...
    private final ROISelectionWizardModel wizardModel;

    public ROISelectionWizard(String title, PreviewDestination parent, ROIWizardReceiver roiImageReceiver, ROISelectionWizardModel model)
    {
        ...
        addWindowListener(new WindowAdapter() 
        {
            ...
            {
                ROISelectionWizard.this.cancel();
            }
        });
