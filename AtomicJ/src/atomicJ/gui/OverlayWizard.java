...
public class OverlayWizard extends JDialog implements PropertyChangeListener, MessageDisplayer
{
    ...
    private final OverlayWizardModel wizardModel;

    public OverlayWizard(PreviewDestination parent, Overlayable overlayable)
    {
        super(parent.getPublicationSite(), "Overlay assistant", ModalityType.MODELESS);

        this.wizardModel = new OverlayWizardModel(parent, overlayable);
    ...
    public OverlayWizardModel getModel()
    {
        return wizardModel;
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) 
    {
        ...
        if(WizardModelProperties.NEXT_ENABLED.equals(property))
        {
        ...
        else if(WizardModelProperties.BACK_ENABLED.equals(property))
        {
            boolean newVal = (boolean)evt.getNewValue();
        ...
        else if(WizardModelProperties.WIZARD_PAGE.equals(property))
        {
