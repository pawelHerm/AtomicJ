...
public class ConcurrentRedoTask extends MonitoredSwingWorker<Void, Void> 
{
    ...
    public void done()
    {
        ...
        if(cancelled)
        {
            JOptionPane.showMessageDialog(resourceManager.getAssociatedWindow(), "Redoing terminated", AtomicJ.APPLICATION_NAME, JOptionPane.INFORMATION_MESSAGE);
        }
        else
        {
            ...
            if(failures > 0)
            {
                JOptionPane.showMessageDialog(resourceManager.getAssociatedWindow(), "Errors occured during redoing of " + failures + " operations", AtomicJ.APPLICATION_NAME, JOptionPane.ERROR_MESSAGE);
            }
        } 	
