...
implements XYItemRenderer, Cloneable, PublicCloneable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.linesVisible, that.linesVisible)) {
            return false;
        }
        if (!Objects.equals(
        ...
        if (!Objects.equals(this.shapesVisible, that.shapesVisible)) {
            return false;
        }
        if (!Objects.equals(
        ...
        if (!Objects.equals(this.shapesFilled, that.shapesFilled)) {
            return false;
        }
        if (!Objects.equals(
