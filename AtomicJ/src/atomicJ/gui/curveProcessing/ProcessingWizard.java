...
public class ProcessingWizard extends JDialog implements PropertyChangeListener, MessageDisplayer
{
    ...
    private final ProcessingSourceSelectionPage pageSources;
    private final List<WizardPage> pages = new ArrayList<>();
    private final ProcessingWizardModel wizardModel;
    private ProcessingModel processingModel;

    public ProcessingWizard(ProcessingModel model)
    {
        ...
        this.pageSources = new ProcessingSourceSelectionPage(processingModel);
        this.pageSettings = new ProcessingSettingsPage(processingModel);

        pages.add(pageSources);
        pages.add(pageSettings);

        this.wizardModel = new ProcessingWizardModel(pages, processingModel);
    ...
    public void propertyChange(PropertyChangeEvent evt) 
    {
        ...
        if(ProcessingWizardModel.NEXT_ENABLED.equals(property))
        {
        ...
        else if(ProcessingWizardModel.NEXT_BATCH_ENABLED.equals(property))
        {
            boolean newVal = (boolean)evt.getNewValue();
        ...
        else if(ProcessingWizardModel.BACK_ENABLED.equals(property))
        {
            boolean newVal = (boolean)evt.getNewValue();
        ...
        else if(ProcessingWizardModel.PREVIOUS_BATCH_ENABLED.equals(property))
        {
            boolean newVal = (boolean)evt.getNewValue();
        ...
        else if(ProcessingWizardModel.FINISH_ENABLED.equals(property))
        {
            boolean newVal = (boolean)evt.getNewValue();
        ...
        else if(ProcessingWizardModel.CURRENT_PAGE.equals(property))
        {
